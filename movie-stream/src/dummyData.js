export const homeData = [
  ...
  export const upcome = [
    {
      id: 1,
      cover: "../assets/images/upcome/u1.jpg",
      name: "My office Boss",
      time: "2hr : 38mins",
    },
    {
      id: 2,
      cover: "../assets/images/upcome/u2.jpg",
      name: "Shadowe",
      time: "2hr : 38mins",
    },
    {
      id: 3,
      cover: "../assets/images/upcome/u3.jpg",
      name: "Another Danger",
      time: "2hr : 38mins",
    },
    {
      id: 4,
      cover: "../assets/images/upcome/u4.jpg",
      name: "One Man Army",
      time: "2hr : 38mins",
    },
    {
      id: 5,
      cover: "../assets/images/upcome/u5.jpg",
      name: "Jumbo Queen",
      time: "2hr : 38mins",
    },
  ]
  export const latest = [
    {
      id: 1,
      cover: "../assets/images/upcome/u6.png",
      name: "King of Jungle",
      time: "2hr : 38mins",
    },
    {
      id: 2,
      cover: "../assets/images/upcome/u7.jpg",
      name: "The illusion",
      time: "2hr : 38mins",
    },
    {
  ...
  export const trending = [
    {
      ...
      genres: "Action",
      tags: "Action, Adventures, Horror",
      cover: "../assets/images/img/slide1.png",
      date: "20-Jan-1997",
    },
    {
      id: 2,
      ...
      genres: "Adventures",
      tags: "Adventures,Animation,Family",
      cover: "../assets/images/img/slide2.jpg",
      date: "10-JUL-2021",
    },
    {
      id: 3,
      ...
      genres: "Adventures",
      tags: "Adventures,Action ",
      cover: "../assets/images/img/slide3.jpg",
      date: "20-FEB-2010",
    },
  ]
  export const recommended = [
    {
      id: 4,
      cover: "../assets/images/rec/rec1.jpg",
      name: "One Man Army",
      time: "2hr : 38mins",
    },
    {
      id: 5,
      cover: "../assets/images/rec/rec2.jpg",
      name: "Jumbo Queen",
      time: "2hr : 38mins",
    },
    {
      id: 1,
      cover: "../assets/images/rec/rec3.jpg",
      name: "My office Boss",
      time: "2hr : 38mins",
    },
    {
      id: 2,
      cover: "../assets/images/rec/rec4.jpg",
      name: "Shadowe",
      time: "2hr : 38mins",
    },
    {
